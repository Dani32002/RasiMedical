...
def create_medicamento(new):
    medicamento = Medicamento(nombre = new["nombre"], estado = new["estado"], descripcion = new["descripcion"], fabricante = new["fabricante"], concentracion = new["concentracion"], administracion = new["administracion"])
    medicamento.save()
    return medicamento
